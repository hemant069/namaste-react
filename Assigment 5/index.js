...
const Headers = () => {
  return (
    <div className="header">
      <img
        src="https://ideogram.ai/api/images/direct/1eDIFZ8fQfm_qB7BoLzE7w.jpg"
        alt="logo"
      />
...
const restautantCard = [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-15 05:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-15 00:45:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-15 04:00:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-03-15 00:59:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
...
const Body = () => {
  return (
    <div className="cards">
      {restautantCard.map((restaurants, index) => (
